...
set search_path ""
lappend search_path "./WORK_SYNTHESIS/tech/${technology}"
...
# DEFINE INPUT FILES
set dir "./WORK_SYNTHESIS/saved/${blockName}/synthesis"
...
source ./dualVth_Group_17.tcl
#source ./materiale_DRAFT.tcl
